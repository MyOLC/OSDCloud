...
Write-Host -ForegroundColor DarkGray "Executing Windows update/drivers"
Start-Process PowerShell -ArgumentList "-NoL -C Invoke-WebPSScript https://raw.githubusercontent.com/MyOLC/OSDCloud/Main/OOBEv11.ps1" -Wait
